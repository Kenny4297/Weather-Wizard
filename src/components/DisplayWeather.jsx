...
const DisplayCurrentWeather = () => {
  ...
  const getTimeForLocation = async (lat, lng) => {
    ...
    try {
      ...
      const timeWithOffset = new Date(currentTime.getTime() + (5 * 60 * 60 * 1000) + timezoneOffsetMilliseconds); // add 5 hours worth of milliseconds and the offset to the current time
      const time = timeWithOffset.toLocaleTimeString([], { hour: 'numeric', minute: '2-digit', hour12: true });
      setTime(time);
    } catch (error) {
      console.log(error);
    }
    ...
    return (
        <div className="row mx-auto future-information-section">
            <div className="col ">
                ...
                >
                    {/* <h3 id="todays-weather">Today's Weather:</h3> */}
                    {weatherData && (
                        <div className="col todays-weather-specs h-25 w-100">
                            ...
                            <p>
                                <span id="display-high-temp">
                                    <span
                                        className="todays-numbers max-min" title="max"
                                    >
                                    ...
                                    <span className="todays-numbers max-min" title="min">
                            ...
                            <p>
                                <span id="display-humidity">
                                    ...
                                    <span className="todays-numbers">{`${weatherData.main.humidity}%`}</span>
                                </span>
                            </p>
                            <p>
                                <span id="wind-speed">
